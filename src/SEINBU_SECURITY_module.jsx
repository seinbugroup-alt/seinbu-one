        ...
        {confirmed?(<Card style={{textAlign:"center",padding:20}}>
          ...
          AUDITS.map(s=>(<Card key={s.icon}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
              ...
              <div style={{textAlign:"right"}}><div style={{fontSize:12,fontWeight:900,color:C.gold}}>{fmt(s.price)} FCFA</div><div style={{fontSize:9,color:C.sub}}>{toPi(s.price)} π</div><div style={{fontSize:7,color:"#A855F7"}}>{fmt(s.price*188495400/10,0)} SBC<div style={{fontSize:7,color:"#A855F7"}}>{fmt(s.price*188495400/10,0)} SBC</div></div>
            </div>
      ...
      {tab==="cert"&&<div style={{padding:16}}>
        ...
        <Card style={{background:"linear-gradient(135deg,#1a0808,#2a0a0a)",border:"1px solid #DC262644"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
            <div><div style={{fontSize:14,fontWeight:800,color:C.light}}>CERT CI</div><div style={{fontSize:10,color:C.sub}}>200 000 FCFA / {lang==="en"?"month":"mois"}</div><div style={{fontSize:9,color:C.sub}}>{toPi(200000)} π<div style={{fontSize:7,color:"#A855F7"}}>{fmt(200000*188495400/10,0)} SBC</div></div>
